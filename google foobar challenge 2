#Google Foobar challenge #2: ion-flux-relabeling problem

#Prompt: Oh no! Commander Lambda's latest experiment to improve the efficiency of her LAMBCHOP doomsday device 
#has backfired spectacularly. She had been improving the structure of the ion flux converter tree, but something 
#went terribly wrong and the flux chains exploded. Some of the ion flux converters survived the explosion intact, 
#but others had their position labels blasted off. She's having her henchmen rebuild the ion flux converter tree 
...
#example, answer(3, [1, 4, 7]) would return the converters above the converters at indexes 1, 4, and 7 in a perfect 
